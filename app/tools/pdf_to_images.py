"""/t/pdf_to_images — render every page of a PDF to JPG/PNG images."""
import json
...
bp = Blueprint("pdf_to_images", __name__)


@bp.get("/", strict_slashes=False)
def page():
    return render_template("tools/pdf_to_images.html", tool=TOOL)
