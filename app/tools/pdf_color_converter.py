"""/t/pdf_color_converter — PDF Color Converter."""
import json
...
bp = Blueprint("pdf_color_converter", __name__)


@bp.get("/", strict_slashes=False)
def page():
    return render_template("tools/pdf_color_converter.html", tool=TOOL)
...
def process():
    ...
    options = {"mode": request.form.get("mode", "grayscale"), "dpi": request.form.get("dpi", "150")}
