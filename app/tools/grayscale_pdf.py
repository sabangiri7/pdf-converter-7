...
bp = Blueprint("grayscale_pdf", __name__)


@bp.get("/", strict_slashes=False)
def page():
    return render_template("tools/grayscale_pdf.html", tool=TOOL)
...
def process():
    ...
    options = {"dpi": request.form.get("dpi", "150")}
